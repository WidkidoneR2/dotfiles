...
config.set(
    ...
    True,
    "file:///home/christian/.local/share/qutebrowser/userscripts/*",
)
...
# ═══════════════════════════════════════════════════════════
# 🌲 Faelight Forest Theme - Tokyo Night Colors
# ═══════════════════════════════════════════════════════════
...
c.colors.completion.item.selected.bg = select
...
c.colors.tabs.selected.odd.bg = select
c.colors.tabs.selected.even.fg = fg
c.colors.tabs.selected.even.bg = select
...
print("🌲 Faelight Forest Qutebrowser theme loaded!")
