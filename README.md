# 🌲 Faelight Forest v3.6.0 - 0-Core Hybrid Architecture
...
![Version](https://img.shields.io/badge/Version-v3.6.0-brightgreen)
...
> **Migration Note:** Switched from Fish to Zsh in v3.6.0 for better bash compatibility and open source accessibility. Fish config preserved in `archive/shell-fish` branch.
...
core-diff since v3.6.0       # Release review
...
- **docs/CHANGELOG-v3.1.md** - v3.6.0 transformation details
- **docs/CHANGELOG-v3.2.md** - v3.6.0 smart updates
