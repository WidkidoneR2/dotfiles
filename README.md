# 🌲 Faelight Forest v6.8.1 - Sway Edition
...
![Version](https://img.shields.io/badge/Version-v6.8.1-brightgreen)
...
> **v6.8.1 Milestone:** Unified faelight CLI, typed TOML configs, Health Engine v0.2, Git governance. 9 custom Rust tools. 🌲🦀
...
|---------|------|-----------|
| v6.8.1 | 2026-01-11 | Fuzzy search launcher, Nushell integration |
| v6.8.1 | 2026-01-10 | Security hardening, UI polish |
