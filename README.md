# 🌲 Faelight Forest v3.3.3 - 0-Core Hybrid Architecture
...
![Version](https://img.shields.io/badge/Version-v3.3.3-brightgreen)
...
> **Migration Note:** Switched from Fish to Zsh in v3.3.3 for better bash compatibility and open source accessibility. Fish config preserved in `archive/shell-fish` branch.
...
- **docs/CHANGELOG-v3.1.md** - v3.3.3 transformation details
- **docs/CHANGELOG-v3.2.md** - v3.3.3 smart updates
