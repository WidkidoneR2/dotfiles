...
# ═══════════════════════════════════════════════════════════
# ⚠️  DANGEROUS COMMAND HIGHLIGHTING (v6.7.1)
# ═══════════════════════════════════════════════════════════
...
if [[ -o interactive ]]; then
    fastfetch
    echo ""
    echo -e "\033[1;32m🌲 Welcome to Faelight Forest v6.7.1 - Sway Edition!\033[0m"
